...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${BASE}/fr/tax-filing-2025/cant-pay`,
    languages: {
...
export default function CantPayFrPage() {
  return (
    <main className="mx-auto max-w-[1200px] px-6 py-12">
      <nav aria-label="Fil d'Ariane" className="mb-6 text-sm text-neutral-500 dark:text-neutral-400">
        <ol className="flex flex-wrap items-center gap-1">
          ...
          <li aria-hidden="true">/</li>
          <li aria-current="page" className="text-neutral-900 dark:text-neutral-100">Impossible de payer</li>
        </ol>
      </nav>
      <h1 className="text-3xl font-semibold tracking-tight text-neutral-900 dark:text-neutral-100">
        Impossible de payer votre solde fiscal 2025 ?
      </h1>
