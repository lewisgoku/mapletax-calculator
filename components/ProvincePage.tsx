...
function basePath(year: TaxYear): string {
  return year === 2026 ? '/income-tax-calculator' : '/income-tax-calculator-2025';
}

export default function ProvincePage({ provinceCode, year }: Props) {
  ...
  // Render prose content with paragraph breaks
    ...
    <main>
      ...
      <section className="mx-auto max-w-3xl px-6 py-10">
        <h2 className="text-xl font-medium text-neutral-900 dark:text-neutral-100">
          {year} {provinceData.name} provincial tax brackets
        </h2>
        <p className="mt-1 mb-4 text-sm text-neutral-500 dark:text-neutral-400">
          These rates apply to your provincial taxable income. Federal tax is calculated
          separately using federal brackets.
        </p>
      ...
      <section className="mx-auto max-w-3xl px-6 pb-12">
        <RelatedProvinces currentCode={provinceCode} year={year} />
      </section>
      ...
      <footer className="mx-auto max-w-3xl px-6 pb-10">
        <p className="text-xs text-neutral-500 dark:text-neutral-400 border-t border-neutral-200 dark:border-neutral-800 pt-6">
          Estimates based on {year} CRA-published rates. Your actual tax may differ based on
